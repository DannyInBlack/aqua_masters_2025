...
def map_joystick_to_thrusters(x, y, tilt, power, pov):
    dead_zone = 0.1  # Small range for calibration

    # Initialize thruster values
    float_thrusters = [0, 0, 0, 0]  # 4 floating thrusters
    # 1, 4, 5, 8 control movement in z axis and rotation

    direction_thrusters = [0, 0, 0, 0]  # 4 directional thrusters
    # 2, 3, 6, 7 control movement in x and y-axis
